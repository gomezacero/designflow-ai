    ...
    <div className="min-h-screen bg-[#F5F5F7] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur-xl border border-white/50 shadow-2xl rounded-[32px] p-8 md:p-12 flex flex-col items-center animate-[floatUp_0.5s_ease-out]">
        ...
        <p className="text-gray-500 text-sm text-center mb-8 px-4 leading-relaxed">
          Manage your design workflows and automate briefs with DesignFlow AI.
        </p>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full group relative bg-white border border-gray-200 hover:border-blue-200 hover:bg-blue-50/50 text-gray-700 font-semibold py-3.5 px-4 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-sm hover:shadow-md active:scale-[0.98]"
        >
            {isLoading ? (
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 w-full flex justify-center">
            <span className="text-xs text-gray-400">DesignFlow AI &copy; 2024</span>
        </div>
      </div>
    </div>
  );
